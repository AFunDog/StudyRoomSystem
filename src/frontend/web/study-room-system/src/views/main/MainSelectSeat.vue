  ...
  <div class="bg-accent p-4 rounded-xl h-full w-full grid-rows-[auto_1fr]">
    ...
    <Dialog v-model:open="isSelectDialogOpen">
      <DialogContent>
        ...
        <div>
          <Form id="bookseat-form" class="flex flex-col gap-y-4" :validation-schema="seatFormSchema" @submit="onSubmit">
    ...
    <div class="flex flex-col items-center justify-center  h-full w-full">
      ...
      <div v-if="selectRoom != null" :class="cn('grid border-gray-500 border-4 rounded-md')" v-show="selectRoom != null"
        :style="{
          'grid-template-columns': `repeat(${selectRoom?.cols},minmax(0,1fr))`
        }">
